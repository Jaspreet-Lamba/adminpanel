...
constructor(public app: App, public rest : RestfullProvider, public nav : NavController, public loadingCtrl: LoadingController, public alertCtrl: AlertController, public menu: MenuController){
