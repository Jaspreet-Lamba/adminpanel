...
export class HomePage implements OnInit {
  ...
  showProfile = false;
	allUsers = [];
  cards: Array<{title: string, firstName: string, lastName: string, email: string, picture: string}> = [];  
	
ngOnInit() {
	this.rest.getUsers().subscribe(res => this.getAllUsers(res))
}
  constructor(public app: App, public navCtrl: NavController, private http: Http, public rest  : RestfullProvider ) {
