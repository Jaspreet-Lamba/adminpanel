...
LoginPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-login',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/adminpanel/LovePoints/src/pages/login/login.html"*/'<ion-content class="card-background-page">\n  <ion-card>\n    <img src="assets/images/login3.jpg"/>\n    <div class="card-title"> \n      <ion-item>\n        <ion-icon name="person" item-start></ion-icon>\n        <ion-input type="text" placeholder="Username" value="" [(ngModel)]="loginUser.email"></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-icon name="lock" item-start></ion-icon>\n        <ion-input  placeholder="Password" type="password" value="" [(ngModel)]="loginUser.password"></ion-input>\n      </ion-item>\n      <ion-item class="login_buttons">\n        <button  class="login_button" ion-button (click) = "onLogin()">Login</button>\n        <button  ion-button (click) = "onRegister()">Sign Up</button>\n      </ion-item>\n    </div>\n  </ion-card>\n</ion-content>'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/adminpanel/LovePoints/src/pages/login/login.html"*/
    }),
...
ListPage = ListPage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-list',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/adminpanel/LovePoints/src/pages/list/list.html"*/'<!-- <ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header> -->\n\n<ion-content>\n  <ion-fab top left>\n    <button ion-fab mini menuToggle><ion-icon name="menu"></ion-icon></button>\n  </ion-fab>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-left></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-right>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n  <ion-tabs>\n    <ion-tab tabTitle="" tabIcon="person"></ion-tab>\n    <ion-tab tabTitle="" tabIcon="people"></ion-tab>\n    <ion-tab tabTitle="" tabIcon="chatboxes"></ion-tab>\n	  <ion-tab tabTitle="" tabIcon="ios-card-outline"></ion-tab> \n  </ion-tabs>\n</ion-content>\n'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/adminpanel/LovePoints/src/pages/list/list.html"*/
    }),
...
NewsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-news',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/adminpanel/LovePoints/src/pages/news/news.html"*/'<ion-content>\n  <ion-fab top left>\n    <button ion-fab mini menuToggle><ion-icon name="menu"></ion-icon></button>\n  </ion-fab>\n  <ion-card>\n    <img src="assets/images/profile2.jpg"/>\n    <ion-card-content>\n      <ion-card-title>\n        Nine Inch Nails Live\n        </ion-card-title>\n      <p>\n        The most popular industrial group ever, and largely\n        responsible for bringing the music to a mass audience.\n      </p>\n    </ion-card-content>\n  </ion-card>\n  <ion-card>\n    <img src="assets/images/profile2.jpg"/>\n    <ion-card-content>\n      <ion-card-title>\n        Nine Inch Nails Live\n        </ion-card-title>\n      <p>\n        The most popular industrial group ever, and largely\n        responsible for bringing the music to a mass audience.\n      </p>\n    </ion-card-content>\n  </ion-card>\n  <ion-card>\n    <img src="assets/images/profile2.jpg"/>\n    <ion-card-content>\n      <ion-card-title>\n        Nine Inch Nails Live\n        </ion-card-title>\n      <p>\n        The most popular industrial group ever, and largely\n        responsible for bringing the music to a mass audience.\n      </p>\n    </ion-card-content>\n  </ion-card>\n  <tab></tab>\n</ion-content>\n'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/adminpanel/LovePoints/src/pages/news/news.html"*/
    }),
